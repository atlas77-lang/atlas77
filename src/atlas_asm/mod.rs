            ...
            match instr {
                ...
                Instruction::CastTo(ty) => {
                    ...
                    let ty_byte = match ty {
                        ...
                        crate::atlas_vm_new::instruction::Type::Integer => 0x01,
                        crate::atlas_vm_new::instruction::Type::Float => 0x02,
                        crate::atlas_vm_new::instruction::Type::UnsignedInteger => 0x03,
                        crate::atlas_vm_new::instruction::Type::Boolean => 0x04,
                        crate::atlas_vm_new::instruction::Type::String => 0x05,
                        crate::atlas_vm_new::instruction::Type::Char => 0x06,
                    };
