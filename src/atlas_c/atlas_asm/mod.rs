...
impl Assembler {
    ...
    pub fn asm_from_instruction(&mut self, source: ProgramDescriptor) -> ASMResult<AsmProgram> {
        ...
        while i < source.len() {
            ...
            match instr {
                ...
                Instruction::ExternCall { func_name, nb_args } => {
                    ...
                    bytecode.push(instruction | ((func_ptr as u32) << 8) | (*nb_args as u32));
                }
                Instruction::Halt => {
